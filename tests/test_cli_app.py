"""Unit tests for the AetherML CLI interface."""
...
from aetherml.interfaces.cli.app import _setup_logging, app
...
class TestSetupLogging:
    def test_verbose_sets_debug_level(self) -> None:
        with patch("aetherml.interfaces.cli.app.logging.basicConfig") as mock_bc:
...
class TestInfoCommand:
    ...
    def test_info_prints_aetherml(self, runner: CliRunner) -> None:
        result = runner.invoke(app, ["info"])
        assert "AetherML" in result.output
