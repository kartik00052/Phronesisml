"""Route handlers for the AetherML REST API.
...
async def detect_target(
    ...
    tmp_path = await _save_upload(file)
    try:
        from aetherml.simple import detect_target_async
...
async def engineer(
    ...
    tmp_path = await _save_upload(file)
    try:
        from aetherml.simple import engineer_async
...
async def recommend_model(
    ...
    tmp_path = await _save_upload(file)
    try:
        from aetherml.simple import select_model_async
...
async def train(
    ...
    tmp_path = await _save_upload(file)
    try:
        from aetherml.simple import train_async
...
async def explain(
    ...
    tmp_path = await _save_upload(file)
    try:
        from aetherml.simple import explain_async
...
async def report(
    ...
    tmp_path = await _save_upload(file)
    try:
        from aetherml.simple import report_async
